...
var treeFactory = function(game, treePosition) {
  ...
  var render_features = {
    render: {
      //fillStyle: 'blue',
      lineWidth: 0,
      sprite: { texture: '/images/tree.png' },
    },
    isStatic:true
  };
  var updated_features = $.extend({}, render_features);
  //var updated_features = GAME_FEATURES.CAR_FEATURES;
  var tree = Bodies.rectangle(treePosition.x, treePosition.y, 20, 20, updated_features);
  // Offset between car's angle and the steering wheel
...
var chekerFactory = function(game, checkerPosition) {
...
var poleFactory = function(game, polePosition) {

  var render_features = {
    render: {
      //fillStyle: 'blue',
      lineWidth: 0,
      sprite: { texture: '/images/snowman.png' },
    },
    isStatic:true
  };
  var updated_features = $.extend({}, render_features);
  //var updated_features = GAME_FEATURES.CAR_FEATURES;
  var northPole = Bodies.rectangle(polePosition.x, polePosition.y, 20, 20, updated_features);
  // Offset between car's angle and the steering wheel
  northPole.rotationAngle = 0;
  northPole.groupId = 1;
